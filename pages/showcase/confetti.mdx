...
import ConfettiSimulator from "@examples/confetti"

export const meta = {
  id: "confetti",
  title: "Coding Confetti on Canvas",
  written: "2021.06.08",
  keywords: ["react", "canvas", "confetti", "particle", "animation"],
}
...
이 글에서는 디테일한 코드는 생략하고 요구사항과 대략적인 구조만 설명한다. 각 코드셋은 설명에 필요한 부분만 따 왔으므로, 전체 코드는 [여기](https://github.com/FourwingsY/portfolio/blob/main/src/hooks/useConfetti.ts)를 참고!
